        ...
        <footer>
            <div className="footer-top section">
                <div className="footer-column">
                    ...
                    <ul className="footer-column-content">
                        <li className="coming-soon"><a href="">Templates</a></li>
                        <li className="coming-soon"><a href="">Resources</a></li>
                        <li className="coming-soon"><a href="">Pricing</a></li>
                ...
                <div className="footer-column">
                    ...
                    <ul className="footer-column-content">
                        <li className="coming-soon"><a href="">Terms</a></li>
                        <li className="coming-soon"><a href="">Privacy Policy</a></li>
                        <li className="coming-soon"><a href="">Copyright</a></li>
                    </ul>
                </div>
            </div>
            <div className="footer-bottom">
                <div className="footer-credits">
                    ...
                    <p>&copy; 2023 Third Space. All rights reserved</p>
                </div>
