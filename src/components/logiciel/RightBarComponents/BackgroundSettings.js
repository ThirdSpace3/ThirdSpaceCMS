    ...
    <div className="parameters-wrapper">
      ...
      >
        <div className="parameters-content-line-row">
          ...
          <input
            type="color"
            onChange={(e) => handleBackgroundChange(e, "backgroundColor")}
        ...
        <div className="parameters-content-line-row">
          ...
          <label class="custom-file-upload">
            <input
              ...
              hidden
              onChange={(e) =>
                modifiedHandleBackgroundChange(e, "backgroundImage")
              }
            />
            <p>Add an Image</p>
        ...
        {/* <div className="parameters-content-line">
          ...
          <div className="parameters-content-line-container">
            <select
              onChange={(e) =>
                handleBackgroundChange(e, "backgroundPosition", "select")
              }
            >
        ...
        <div className="parameters-content-line">
          ...
          <div className="parameters-content-line-container">
            <select
              onChange={(e) =>
                handleBackgroundChange(e, "backgroundSize", "select")
              }
            >
