...
const FeaturesSection = ({ handleSettingsChange, setSelectedElement, style, settings, openImagePanel, isPreviewMode }) => {
  ...
  return (
    <div className="sss-product-features" style={{ ...featureStyles }} id='features' onClick={isPreviewMode ? undefined : (event) => handleComponentClick(event, 'features')}>
      <h2 className="sss-product-features-title" id='featuresTitle' onClick={isPreviewMode ? undefined : (event) => handleComponentClick(event, 'featuresTitle')} style={{ ...featureTitleStyles }}>
        {isPreviewMode ? featuresTitleText : (
          <EditableText
      ...
      <div className="sss-product-features-box">
        ...
        <div className="sss-product-features-box-top">
          <div className="sss-product-features-box-top-left">
            <h3 className="sss-product-features-box-top-left-title" id='endToEndTitle' onClick={isPreviewMode ? undefined : (event) => handleComponentClick(event, 'endToEndTitle')} style={{...endToEndTitleStyles}}>
              {isPreviewMode ? endToEndText : (
                <EditableText
                  text={endToEndText}
            ...
            <p className='sss-product-features-box-top-left-text'  id='endToEndDescription' onClick={isPreviewMode ? undefined : (event) => handleComponentClick(event, 'endToEndDescription')} style={{...endToEndDescriptionStyles}}>
              {isPreviewMode ? endToEndDesc.text : (
                <EditableText
            ...
            <Link to="/join-us" className="sss-product-navbar-cta" id='featuresJoinUs' onClick={isPreviewMode ? undefined : (event) => handleComponentClick(event, 'featuresJoinUs')} style={{...featuresJoinsUsStyles}}>
          ...
          <div className="sss-product-features-box-top-right">
            {isPreviewMode ? (
              <img src={feature1Image} alt="Feature 1" style={{ height: imageHeight1 }} />
            ) : (
              <ReusableImage
                src={feature1Image}
        ...
        <div className="sss-product-features-box-bottom">
          <div className="sss-product-features-box-bottom-left">
            {isPreviewMode ? (
              <img src={feature2Image} alt="Mobile applications" style={{ height: imageHeight2 }} />
            ) : (
              <ReusableImage
                src={feature2Image}
            ...
            <h3 className="sss-product-features-box-bottom-left-title"  id='mobileAppTitle' onClick={isPreviewMode ? undefined : (event) => handleComponentClick(event, 'mobileAppTitle')}>
              {isPreviewMode ? mobileAppsText : (
                <EditableText
                  text={mobileAppsText}
            ...
            <p className='sss-product-features-box-top-left-text' id='mobileAppDescription' onClick={isPreviewMode ? undefined : (event) => handleComponentClick(event, 'mobileAppDescription')} style={{...mobileAppsDescriptionStyles}}>
              {isPreviewMode ? mobileAppsDesc.text : (
                <EditableText
          ...
          <div className="sss-product-features-box-bottom-right">
            <h3 className="sss-product-features-box-bottom-right-title" id='uploadShareTitle' onClick={isPreviewMode ? undefined : (event) => handleComponentClick(event, 'uploadShareTitle')} style={{...uploadShareTitleStyles}}>
              {isPreviewMode ? uploadShareText : (
                <EditableText
            ...
            <p className='sss-product-features-box-top-left-text' id='uploadShareDescription' onClick={isPreviewMode ? undefined : (event) => handleComponentClick(event, 'uploadShareDescription')} style={{...uploadShareDescriptionStyles}}>
              {isPreviewMode ? uploadShareDesc.text : (
                <EditableText
            ...
            {isPreviewMode ? (
              <img src={feature3Image} alt="Feature 3" style={{ height: imageHeight3 }} />
            ) : (
              <ReusableImage
                src={feature3Image}
