...
import { getFirestore, updateDoc , doc, setDoc, where, getDocs,getDoc, collection, query } from 'firebase/firestore';
...
export {analytics, db, doc, setDoc, updateDoc, where, getDocs, collection, query, getDoc };